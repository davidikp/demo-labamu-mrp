...
import { PurchaseOrderSearchShell } from "../../../modules/purchase-order/components/PurchaseOrderSearchShell.jsx";
import {
...
} from "../../../modules/purchase-order/utils/purchaseOrderTableUtils.js";
...
export const QuoteSettingsPage = ({
  ...
  const [isApprovalActive, setIsApprovalActive] = useState(
    quoteApprovalSettings?.isApprovalActive || false
  );
  const [requireComment, setRequireComment] = useState(
    quoteApprovalSettings?.requireComment || false
  );
  const [approvers, setApprovers] = useState(
    quoteApprovalSettings?.approvers || []
  );
  ...
  const initialSnapshotRef = useRef(
    JSON.stringify({
      isApprovalActive: quoteApprovalSettings?.isApprovalActive || false,
      requireComment: quoteApprovalSettings?.requireComment || false,
      approvers: quoteApprovalSettings?.approvers || [],
    })
  );
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <span style={{ fontSize: "var(--text-body)", lineHeight: "1.5" }}>
              Quote settings successfully saved
            </span>
          </div>
          <button
            type="button"
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Enable approval workflow for Quote
                </span>
              </div>
              <ToggleSwitch
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    >
                      When enabled, approvers must provide a comment. When
                      disabled, the comment field is still shown but optional.
                    </span>
                  </div>
                  <ToggleSwitch
                ...
                >
                  ...
                  >
                    ...
                    >
                      {approverError || "Select users who can approve Quote"}
                    </span>
                  </div>
                      ...
                      <div style={{ width: isMobile ? "100%" : "calc((100% - 80px) * 1.2 / 3.6)" }}>
                        ...
                        >
                          ...
                          <input
                            ...
                            placeholder="Search by name or user group..."
                            style={{
                              flex: 1,
                              height: "100%",
                              width: "100%",
