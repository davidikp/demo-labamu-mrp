...
export const OrderSettingsPage = ({
  ...
  const [isApprovalActive, setIsApprovalActive] = useState(
    orderApprovalSettings?.isApprovalActive || false
  );
  const [requireComment, setRequireComment] = useState(
    orderApprovalSettings?.requireComment || false
  );
  const [approvers, setApprovers] = useState(
    orderApprovalSettings?.approvers || []
  );
  ...
  const initialSnapshotRef = useRef(
    JSON.stringify({
      isApprovalActive: orderApprovalSettings?.isApprovalActive || false,
      requireComment: orderApprovalSettings?.requireComment || false,
      approvers: orderApprovalSettings?.approvers || [],
    })
  );
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <span style={{ fontSize: "var(--text-body)", lineHeight: "1.5" }}>
              Order settings successfully saved
            </span>
          </div>
          <button
            type="button"
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Enable approval workflow for Order
                </span>
              </div>
              <ToggleSwitch
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {approverError ||
                        "Select users who can approve Orders"}
                    </span>
                  </div>
